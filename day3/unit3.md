# Hands-on exercise for day 3 unit 3:<br/>Creating an overview page

## Previous exercise
[Hands-On exercise for day 3 unit 2: Enhancing the analytical list page](unit2.md)
...
6. In this step we will select the data source for the project.
    ...
    **Note:** Choose the service you created during  1 unit 5.
...
In Overview page, you can create cards using OData V4 service as well. We will now add an OData V4 service to our project that was created during Day 1 of the course. Later we will use this OData V4 service to create a table card.
...
5. Click **ZUI_FE_TRAVEL_######_O4 > ZFE_TRAVEL_###### (0001) - odata v4**
   ...
   **Note.** Choose the OData V4 service you created during day 1 unit 5.
   <br><br>
6. Click **Add**
...
In this step, we will configure navigation to the list report application that we developed during day 1.
...
## Next Exercise
[Day 3 Unit 4: Deploying your SAP Fiori elements app](unit4.md)
